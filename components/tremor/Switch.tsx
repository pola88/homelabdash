...
const switchVariants = tv({
  slots: {
    root: [
      // base
      "group relative isolate inline-flex shrink-0 cursor-pointer items-center rounded-full px-1.5 shadow-inner outline-hidden ring-1 ring-inset transition-all",
